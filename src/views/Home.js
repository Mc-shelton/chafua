...
function Home({navigation}) {
  ...
  const categFilter = (name)=>{
    if(name != 'All'){
    setHotelList(hotelConstList.filter(categ => categ.categories.includes(name)))
    }else{
  ...
  return (
    ...
    <View style={{
      ...
      <TextInput
        ...
        onSubmitEditing={(e)=>navigation.navigate('Search',{params:{isSearching:true,word:e.target.value}})}
      />
      ...
      <ImageBackground
          ...
          source={'https://media.npr.org/assets/img/2022/06/06/gettyimages-1199291938-40_custom-7191b02345de50bf85961f6342c202dd9d6d20a0-s800-c85.webp'}
        />
        ...
        <MasonryList
          ...
          renderItem={({item}) => {
            return (
              ...
              onPress={()=>{
                navigation.navigate('Hotel',{params:{title:item.name}})
              }}
